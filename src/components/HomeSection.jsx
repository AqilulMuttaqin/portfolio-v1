    ...
    <div id="home" className="flex justify-center min-h-svh bg-white">
      <div className="flex flex-col items-center justify-center text-center max-w-screen-lg mx-auto px-4 py-16">
        ...
        <div className="relative inline-block mt-[-16px]">
          <p
            className="text-[80px] sm:text-[122px] lg:text-[164px] bg-gradient-to-r from-cyan-900 to-cyan-800 bg-clip-text text-transparent font-extrabold tracking-[-.08em] leading-none mb-[-15px] sm:mb[-20px] lg:mb-[-25px]"
            data-aos="fade-right"
            data-aos-delay="100"
          >
            AQILUL
          ...
          />
          <p
            className="text-[80px] sm:text-[122px] lg:text-[164px] bg-gradient-to-r from-cyan-900 to-cyan-800 bg-clip-text text-transparent font-extrabold tracking-[-.08em] leading-none"
            data-aos="fade-left"
            data-aos-delay="200"
          >
            MUTTAQIN
